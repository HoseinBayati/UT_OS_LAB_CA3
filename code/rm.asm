...
printint(int fd, int xx, int base, int sgn)
{
 ...
 464:	0f b6 91 1c 0b 00 00 	movzbl 0xb1c(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 59e:	75 25                	jne    5c5 <printf+0xff>
          s = "(null)";
 5a0:	c7 45 f4 aa 08 00 00 	movl   $0x8aa,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 667:	a1 38 0b 00 00       	mov    0xb38,%eax
 ...
 732:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 737:	90                   	nop
 738:	c9                   	leave  
 739:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 790:	83 c4 10             	add    $0x10,%esp
  return freep;
 793:	a1 38 0b 00 00       	mov    0xb38,%eax
}
 798:	c9                   	leave  
 799:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7bd:	c7 45 f0 30 0b 00 00 	movl   $0xb30,-0x10(%ebp)
 7c4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c7:	a3 38 0b 00 00       	mov    %eax,0xb38
 7cc:	a1 38 0b 00 00       	mov    0xb38,%eax
 7d1:	a3 30 0b 00 00       	mov    %eax,0xb30
    base.s.size = 0;
 7d6:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7dd:	00 00 00 
  }
 ...
 833:	a3 38 0b 00 00       	mov    %eax,0xb38
      return (void*)(p + 1);
 ...
 83e:	eb 3b                	jmp    87b <malloc+0xe1>
    ...
    if(p == freep)
 840:	a1 38 0b 00 00       	mov    0xb38,%eax
