...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 3f 03 00 00       	call   392 <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 474:	0f b6 91 2c 0b 00 00 	movzbl 0xb2c(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5ae:	75 25                	jne    5d5 <printf+0xff>
          s = "(null)";
 5b0:	c7 45 f4 ba 08 00 00 	movl   $0x8ba,-0xc(%ebp)
        while(*s != 0){
...
morecore(uint nu)
{
 ...
 7a0:	83 c4 10             	add    $0x10,%esp
  return freep;
 7a3:	a1 48 0b 00 00       	mov    0xb48,%eax
}
 7a8:	c9                   	leave  
 7a9:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7bc:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7bf:	a1 48 0b 00 00       	mov    0xb48,%eax
 7c4:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7cb:	75 23                	jne    7f0 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7cd:	c7 45 f0 40 0b 00 00 	movl   $0xb40,-0x10(%ebp)
 7d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d7:	a3 48 0b 00 00       	mov    %eax,0xb48
 7dc:	a1 48 0b 00 00       	mov    0xb48,%eax
 7e1:	a3 40 0b 00 00       	mov    %eax,0xb40
    base.s.size = 0;
 7e6:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 7ed:	00 00 00 
  }
 ...
 843:	a3 48 0b 00 00       	mov    %eax,0xb48
      return (void*)(p + 1);
 ...
 84e:	eb 3b                	jmp    88b <malloc+0xe1>
    ...
    if(p == freep)
 850:	a1 48 0b 00 00       	mov    0xb48,%eax
